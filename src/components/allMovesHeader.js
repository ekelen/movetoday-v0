          ...
          <button
            ...
            className={`${
              focus === focusFilter || (!focusFilter && focus === "any")
                ? "bg-primaryAction-500 whitespace-nowrap uppercase text-xs w-min py-1 px-2 rounded-full"
                : "bg-primary-400 opacity-60 whitespace-nowrap uppercase text-xs w-min py-1 px-2 rounded-full"
            }`}
